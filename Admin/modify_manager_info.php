                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<form action='edit_manager_info.php' method='post' style='display: inline-block;'>";
                            echo "<input type='hidden' name='manager_id' value='" . $row["Manager_id"] . "'>";
                            echo "<button type='submit' name='update' class='bg-blue-500 text-white px-4 py-2 rounded'>Update</button>";
                            echo "</form>";
                            echo "<form action='edit_manager_info.php' method='post' style='display: inline-block; margin-left: 10px;'>";
                            echo "<input type='hidden' name='manager_id' value='" . $row["Manager_id"] . "'>";
                        ...
                        echo "<tr><td colspan='6' class='px-5 py-5 border-b border-gray-200 bg-white text-sm text-center'>No records found.</td></tr>";
                    }
