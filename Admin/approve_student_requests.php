                    ...
                    <tbody class="text-gray-600 text-sm divide-y divide-gray-300">
                        ...
                        if ($result_students->num_rows > 0) {
                            while ($row = $result_students->fetch_assoc()) {
                                ...
                                echo "<form action='approve_student.php' method='post'>";
                                echo "<input type='hidden' name='approveUserId' value='" . $row["Student_id"] . "'>";
                                echo "<button type='submit' name='approveUser' class='bg-green-500 text-white px-4 py-2 rounded'>Approve</button>";
                                echo "</form>";
                                echo "</td>";
                            }
                        } else {
                            echo "<tr><td colspan='4' style='background-color: white;' class='px-5 py-5 border-b border-gray-500 text-sm'>No students found.</td></tr>";
                        }
                        $conn->close();
